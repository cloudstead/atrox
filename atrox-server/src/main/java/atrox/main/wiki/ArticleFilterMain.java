...
import static atrox.model.canonical.CanonicalEntity.canonicalize;
...
public class ArticleFilterMain extends MainBase<ArticleFilterOptions> {
    ...
    @Override protected void run() throws Exception {
        ...
        final File[] indexFiles = FileUtil.listFiles(options.getDir(), new FileSuffixFilter("_index.json"));
