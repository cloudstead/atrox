...
function newSearchLink (term) {
    ...
    return (typeof term == "undefined") ? '?lookup error?' : '<a href="." class="searchLink" style="text-decoration: none; color: black" onclick="newExactSearch(\''+term.escape()+'\'); return false;">'+term+'</a>'
}
