...
function init_resizer (canvasId, imageSource) {
    ...
    function draw(withAnchors, withBorders) {
        ...
        // draw the image
        var widthLimit = $(window).width() - 100;
        var heightLimit = $(window).height() - 100;
    ...
    jqCanvas.mouseup(function (e) {
        handleMouseUp(e);
    });
    jqCanvas.mouseout(function (e) {
        handleMouseOut(e);
    });
}