...
"{{block2|nested=look at {{this infobox|insideof = another | crazy=and it has a [[double-embedded|extra [[link|foobar~~!@]] inside!]] with two more {{nested infobox}}{{here is the second one}}}}"
            ;
